...
def get_search_details(info_id):
    ...
    return jsonify([{'id':detail.id,'link': detail.link, 'title': detail.title, 'keywords_extracted': detail.keywords_extracted, 'confidence_level': detail.confidence_level} for detail in details]), 200, {'Content-Type': 'application/json; charset=utf-8'}
